<section id="home-news" class="gu-Home-news">
    ...
    <div id="gu-News-swiper" class="gu-News-swiper swiper-container">
            ...
            <div class="gu-News-post swiper-slide">
                <div class="gu-News-post__inner">
                    ...
                    <div class="gu-News-post__picture"
                        <?php if ( has_post_thumbnail($recent["ID"]) ) : ?>style="background-image: url(<?php echo $picturePath; ?>)" data-cover-picture <?php endif; ?>>
                    </div>
